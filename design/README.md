...
Lưu trữ tất cả tài liệu thiết kế của dự án.
...
**Owner**: @ux-designer (`wireframes/`, `specs/`, `flows/`), @ux-researcher (`research/`)

> Tạo subfolders khi cần. File này chỉ giữ thư mục trong Git.
