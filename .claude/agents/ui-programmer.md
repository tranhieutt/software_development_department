...
2. **Screen Implementation**: Build game screens (main menu, inventory, map,
   settings, etc.) following mockups from ux-designer and flows from
   ux-designer.
...
- Design UI layouts or visual style (implement specs from ux-designer/ux-designer)
...
### Implements specs from: `ux-designer`, `ux-designer`
