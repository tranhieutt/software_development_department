<p align="center">
  ...
  <p align="center">
    ...
    <br /><br />
    28 agents · 125 context-optimized skills · 10/12 agentic harness patterns · MAS Infrastructure · Steel Discipline · Runtime-proven harness
  </p>
</p>
...
- **Routing chính xác**: 125 skills với `paths:` triggers, `when_to_use:` semantics, và `effort:` scores cho phép AI tự route mà không cần người dùng điều hướng thủ công
...
| #7 Skill Routing | ✅ | 125 skills với metadata `paths:`, `when_to_use:`, `effort:` |
...
Gõ `/` trong Claude Code — bạn thấy cái relevant, không phải cả 125.
...
**Antigravity Platform**: Mở thư mục trong Antigravity. Kiến trúc `.claude/` tự động load. Toàn bộ 125 workflows sẵn sàng ngay — chỉ cần giao việc.
