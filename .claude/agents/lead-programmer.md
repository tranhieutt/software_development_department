...
model: sonnet
maxTurns: 20
skills: [code-review, code-review-checklist, architecture-decision, architecture-decision-records, tech-debt, commit, pr-writer, gitnexus-impact-analysis, gitnexus-refactoring, gitnexus-pr-review]
---
...
- Change infrastructure or deployment (delegate to devops-engineer)

### Delegation Map

Delegates to:
- `frontend-developer` for UI feature implementation
- `backend-developer` for server-side feature implementation
- `fullstack-developer` for end-to-end feature delivery
- `ai-programmer` for AI and ML system implementation
- `network-programmer` for networking and real-time features
- `tools-programmer` for development tools and automation
