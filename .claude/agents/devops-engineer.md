...
- `docs/technical/INFRASTRUCTURE.md` — CI/CD and infrastructure documentation (when this file exists)
- `infra/` — All pipeline configuration files and infrastructure-as-code
...
- `docs/technical/DECISIONS.md` — ADR history (informs infrastructure choices).
...
- Modify application code or configuration without review
